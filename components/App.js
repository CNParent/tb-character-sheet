class App extends Component {
    ...
    drawContent = () => {
        ...
        if (this.state.navbar.tab == 'inventory') return this.add(new Inventory('inventory', { inventory: this.state.inventory }));
        if (this.state.navbar.tab == 'notes') return this.add(new Notes('notes', { notes: this.state.notes, filter: '' }));
